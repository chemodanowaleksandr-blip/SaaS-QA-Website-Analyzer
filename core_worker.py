...
def main():
    ...
    t = {
        "Русский": {
            ...
            "limit_notice": "⚠️ Free plan лимит: Проверено только первые 50 ссылок из {}. Активируйте Premium для проверки всех элементов.",
            "type_int": "Внутренняя",
            "type_ext": "Внешняя",
        ...
        "English": {
            ...
            "spinner": "Engine is purging all extracted URLs...",
            ...
            "limit_notice": "⚠️ Free plan limit: evaluated only first 50 links out of {}. Activate Premium to audit the entire infrastructure.",
            "type_int": "Internal",
            "type_ext": "External",
